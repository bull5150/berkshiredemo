...
namespace API_Scratcher.Services
{
    ...
    {
        public Models.reasons_description descriptionBuilder(int id)
        {
            Models.reasons_description modelDescription = new Models.reasons_description();
            switch (id)
            {
                case 1:
                    ...
                    + ", in addition to being able to possibly develop .NetCore and Blazer Applications."
                    + "  Both are high on my list of skills I would like to pursue in the future.";
                    return modelDescription;
                case 2:
                    modelDescription.id = 2;
                    modelDescription.reason_Description = @"Working for Berkshire Hathaway will"
                    + " allow me to have a stable career.  I was with Ameritrade for 12 years and would like to have an "
                ...
                case 3:
                    ...
                    + "which means I have been solving a lot of the same puzzles.  I am looking forward to being somewhere new "
